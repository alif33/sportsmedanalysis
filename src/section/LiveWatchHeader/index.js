    ...
    return (
        <div className="bg-black">
            ...
            <div className={style._smd_watch_system}>
                ...
                <ul>
                    <li><Image height="16" width="52" src="/images/watch/roku.png" alt="" /></li>
                    <li><Image height="17" width="37" src="/images/watch/apple-tv.png" alt="" /></li>
                    <li><Image height="17" width="14" src="/images/watch/apple.png" alt="" /></li>
