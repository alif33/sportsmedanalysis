        ...
        <div className="row align-items-center">
          <div className="col-md-5">
            <div className={`w-100 pt-2 ${style.podcatsImage}`}>
              <Image
                width="489"
                height="312"
                src="/images/podcast/featured.png"
                alt=""
              />
            </div>
          </div>
          <div className="col-md-7">
            <div className={style.featured_text}>
              ...
              <p>
                Looking for the best picks against the spread, sharp action on
                the total and props you can take to the ticket window? Join The
                Coach, Jonathan Coachman, on the Early Edge as he speaks with
                the best handicappers to preview every
              </p>
